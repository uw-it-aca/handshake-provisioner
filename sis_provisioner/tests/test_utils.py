...
class HandshakeUtilsTest(TestCase):
    ...
    def test_get_quarter_from_date(self):
        ...
        self.assertEqual(get_quarter_from_date(datetime(2022, 1, 3, 1, 0)), 1)
        self.assertEqual(get_quarter_from_date(datetime(2020, 4, 1, 1, 0)), 2)
        self.assertEqual(get_quarter_from_date(datetime(2022, 6, 20, 1, 0)), 3)
        self.assertEqual(get_quarter_from_date(datetime(2020, 10, 1, 1, 0)), 4)
        self.assertEqual(get_quarter_from_date(datetime(2022, 1, 2, 1, 0)), 4)
        self.assertEqual(get_quarter_from_date(datetime(2020, 4, 1, 1, 0)), 2)
        self.assertEqual(get_quarter_from_date(datetime(2022, 9, 27, 1, 0)), 3)
        self.assertEqual(get_quarter_from_date(datetime(2022, 9, 28, 1, 0)), 4)
        self.assertEqual(get_quarter_from_date(datetime(2022, 3, 27)), 1)
        self.assertEqual(get_quarter_from_date(datetime(2022, 3, 28)), 2)
        self.assertEqual(get_quarter_from_date(datetime(2020, 7, 1, 2, 0)), 3)
        self.assertEqual(get_quarter_from_date(datetime(2023, 6, 20, 2, 0)), 3)
