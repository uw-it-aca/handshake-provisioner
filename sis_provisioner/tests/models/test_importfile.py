...
class HandshakeStudentsFileTest(TestCase):
    ...
    def test_create_path(self):
        ...
        self.assertEqual(impfile.json_data(), {
            ...
            'created_by': 'internal',
            'created_date': '2019-06-15T02:45:00',
            'generated_date': None,
            'id': 1,
            'import_progress': 0,
            'imported_date': None,
    ...
    def test_create_path_prefix(self):
        impfile = HandshakeStudentsFile(term=self.term, is_test_file=True)
        impfile.created_date = datetime(2019, 6, 15, 2, 45, 0)
        impfile.save()
...
class FosterStudentsFileTest(TestCase):
    ...
    def test_create_path(self):
        impfile = FosterStudentsFile(term=self.term)
        impfile.created_date = datetime(2019, 6, 15, 2, 45, 0)
        impfile.save()
