...
from sis_provisioner.dao.file import write_file
from sis_provisioner.dao.student import get_students_for_handshake
from sis_provisioner.utils import (
    valid_major_codes, get_major_names, get_primary_major_name,
    get_synced_college_name)
    ...
    def generate_csv(self):
        ...
        for person in get_students_for_handshake():
            ...
            writer.writerow([
                ...
                person.student.class_desc.title(),
                person.surname,
                person.first_name,
                ...
                person.student.campus_desc.title(),
                get_major_names(person.student.majors),  # TODO: match case
                get_primary_major_name(person.student.majors),  # TODO: match case
                person.active_student.upper(),
            ])
